...
function modeSwitcher(){const currentMode=document.documentElement.getAttribute('data-theme');console.log(currentMode,'mode')
if(currentMode==="dark"){goLightMeta();setLight();goLight();}else{goDarkMeta();setDark();goDark();}}
